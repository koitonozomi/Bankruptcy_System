 ...
 */
async function sendChatworkNotification(caseItem, condition) {
...
--------------------`;
    try {
        await axios.post(`https://api.chatwork.com/v2/rooms/${roomId}/messages`, new URLSearchParams({ body: message }).toString(), // ★ application/x-www-form-urlencoded 形式に修正
